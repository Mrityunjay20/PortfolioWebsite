        ...
        <div className="container px-5 py-4 mx-auto">
          <div className="flex flex-col text-center w-full mb-12">
            ...
            <p className="mx-auto text-center md:w-1/2 sm:1/3  text-gray-200">
              This is a concise overview of my career. For a more detailed
              account of my professional background, including specific roles,
              projects, and endorsements, I invite you to visit my{" "}
              <a href={linkedinLink} className="text-[#4cd8f7]">
                LinkedIn
              </a>{" "}
              profile.
              <br /> There, you'll gain deeper insights into my skills,
              achievements, and professional network.
            </p>
          </div>
        </div>
      </section>
                ...
                <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                  ...
                  <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <p className="w-full md:w-10/12 text-white md:hidden">
                      ...
                      <Link className="text-blue-500" to={linkedinLink}>
                        ....(view more)
                      </Link>
                    </p>
                  </div>
