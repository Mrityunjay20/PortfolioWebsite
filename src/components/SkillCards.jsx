    ...
    return(
        <div className={`${Spacing} p-4`}>
            <div className="w-full h-max bg-slate-950 rounded-xl lg:py-3 p-4">
                <div>
                    <h1 className="text-[#cce7f6] mx-auto my-4 text-2xl w-max font-semibold uppercase text-center">{Heading}</h1>
                </div>
                <div>
                    <ul className="text-[#4cd8f7] w-full mx-auto my-2 aspect-auto flex flex-row justify-center text-base font-mono leading-10 space-x-4 overflow-x-auto">
